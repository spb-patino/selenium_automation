...
public class SuccessfulPurchaseTest {
        ...
        public void testSuccessfulPurchase() {
                ...
                WebElement buttonFirstProduct = driver
                                .findElement(By.xpath(UseCaseXpathDefinitions.anchorButtonFirstProduct));
                ...
                WebElement buttonShoppingCart = driver
                                .findElement(By.xpath(UseCaseXpathDefinitions.anchorButtonShoppingCart));
                ...
                WebElement inputPostalCode = driver
                                .findElement(By.xpath(UseCaseXpathDefinitions.anchorInputPostalCode));
                ...
                float firstProductPrice = Float
                                .parseFloat(textFirstProductPrice.getText().replace(PageTexts.moneySimbol, ""));
                ...
                float itemTotalFromPage = Float
                                .parseFloat(textItemTotal.getText().replace(PageTexts.itemTotalMoneySimbol, ""));
