...
public class SuccessfulPurchaseTest {
    ...
    public void testSuccessfulPurchase() {
        ...
        WebElement buttonFirstProduct = driver.findElement(By.xpath(UseCaseXpathDefinitions.anchorButtonFirstProduct));
        buttonFirstProduct.click();

        WebElement buttonSecondProduct = driver
                .findElement(By.xpath(UseCaseXpathDefinitions.anchorButtonSecondProduct));
        buttonSecondProduct.click();

        WebElement buttonShoppingCart = driver.findElement(By.xpath(UseCaseXpathDefinitions.anchorButtonShoppingCart));
        ...
        WebElement inputPostalCode = driver.findElement(By.xpath(UseCaseXpathDefinitions.anchorInputPostalCode));
        ...
        WebElement buttonCheckoutContinue = driver
                .findElement(By.xpath(UseCaseXpathDefinitions.anchorButtonCheckoutContinue));
        buttonCheckoutContinue.click();

        WebElement textFirstProductPrice = driver
                .findElement(By.xpath(UseCaseXpathDefinitions.anchorTextFirstProductPrice));
        float firstProductPrice = Float.parseFloat(textFirstProductPrice.getText().replace(PageTexts.moneySimbol, ""));
        System.out.println(firstProductPrice);

        WebElement textSecondProductPrice = driver
                .findElement(By.xpath(UseCaseXpathDefinitions.anchorTextSecondProductPrice));
        float secondProductPrice = Float
                .parseFloat(textSecondProductPrice.getText().replace(PageTexts.moneySimbol, ""));
        ...
        float itemTotalFromPage = Float.parseFloat(textItemTotal.getText().replace(PageTexts.itemTotalMoneySimbol, ""));
        ...
        WebElement buttonFinishCheckout = driver
                .findElement(By.xpath(UseCaseXpathDefinitions.anchorButtonFinishCheckout));
